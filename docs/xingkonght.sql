/*
 ...
 Source Database       : xingkonght

 Target Server Type    : MySQL
 Target Server Version : 50624
 File Encoding         : utf-8

 Date: 03/15/2017 16:53:23 PM
*/
...
-- ----------------------------
--  Table structure for `ht_asset`
-- ----------------------------
DROP TABLE IF EXISTS `ht_asset`;
CREATE TABLE `ht_asset` (
...
-- ----------------------------
--  Table structure for `ht_auth_access`
-- ----------------------------
DROP TABLE IF EXISTS `ht_auth_access`;
CREATE TABLE `ht_auth_access` (
...
-- ----------------------------
--  Table structure for `ht_auth_rule`
-- ----------------------------
...
-- ----------------------------
--  Table structure for `ht_common_action_log`
-- ----------------------------
DROP TABLE IF EXISTS `ht_common_action_log`;
CREATE TABLE `ht_common_action_log` (
...
-- ----------------------------
--  Table structure for `ht_guestbook`
-- ----------------------------
DROP TABLE IF EXISTS `ht_guestbook`;
CREATE TABLE `ht_guestbook` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
--  Table structure for `ht_links`
-- ----------------------------
DROP TABLE IF EXISTS `ht_links`;
CREATE TABLE `ht_links` (
...
-- ----------------------------
BEGIN;
INSERT INTO `ht_links` VALUES ('1', 'http://www.thinkcmf.com', 'ThinkCMF', '', '_blank', '', '1', '0', '', '0');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `ht_nav` VALUES ('1', '1', '0', '首页', '', 'home', '', '1', '0', '0-1'), ('2', '1', '0', '列表演示', '', 'a:2:{s:6:\"action\";s:17:\"Portal/List/index\";s:5:\"param\";a:1:{s:2:\"id\";s:1:\"1\";}}', '', '1', '0', '0-2'), ('3', '1', '0', '瀑布流', '', 'a:2:{s:6:\"action\";s:17:\"Portal/List/index\";s:5:\"param\";a:1:{s:2:\"id\";s:1:\"2\";}}', '', '1', '0', '0-3');
COMMIT;

-- ----------------------------
--  Table structure for `ht_nav_cat`
-- ----------------------------
DROP TABLE IF EXISTS `ht_nav_cat`;
CREATE TABLE `ht_nav_cat` (
...
-- ----------------------------
--  Records of `ht_nav_cat`
-- ----------------------------
BEGIN;
INSERT INTO `ht_nav_cat` VALUES ('1', '主导航', '1', '主导航');
COMMIT;

-- ----------------------------
--  Table structure for `ht_oauth_user`
-- ----------------------------
DROP TABLE IF EXISTS `ht_oauth_user`;
CREATE TABLE `ht_oauth_user` (
...
-- ----------------------------
--  Table structure for `ht_options`
-- ----------------------------
DROP TABLE IF EXISTS `ht_options`;
CREATE TABLE `ht_options` (
...
-- ----------------------------
--  Table structure for `ht_posts`
-- ----------------------------
DROP TABLE IF EXISTS `ht_posts`;
CREATE TABLE `ht_posts` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
BEGIN;
INSERT INTO `ht_role` VALUES ('1', '超级管理员', '0', '1', '拥有网站最高管理员权限！', '1329633709', '1329633709', '0');
COMMIT;

-- ----------------------------
--  Table structure for `ht_role_user`
-- ----------------------------
DROP TABLE IF EXISTS `ht_role_user`;
CREATE TABLE `ht_role_user` (
...
-- ----------------------------
--  Table structure for `ht_route`
-- ----------------------------
DROP TABLE IF EXISTS `ht_route`;
CREATE TABLE `ht_route` (
...
-- ----------------------------
--  Table structure for `ht_slide_cat`
-- ----------------------------
DROP TABLE IF EXISTS `ht_slide_cat`;
CREATE TABLE `ht_slide_cat` (
...
-- ----------------------------
--  Table structure for `ht_term_relationships`
-- ----------------------------
DROP TABLE IF EXISTS `ht_term_relationships`;
CREATE TABLE `ht_term_relationships` (
...
-- ----------------------------
--  Table structure for `ht_terms`
-- ----------------------------
DROP TABLE IF EXISTS `ht_terms`;
CREATE TABLE `ht_terms` (
...
-- ----------------------------
BEGIN;
INSERT INTO `ht_terms` VALUES ('1', '列表演示', '', 'article', '', '0', '0', '0-1', '', '', '', 'list', 'article', '0', '1'), ('2', '瀑布流', '', 'article', '', '0', '0', '0-2', '', '', '', 'list_masonry', 'article', '0', '1');
COMMIT;

-- ----------------------------
--  Table structure for `ht_user_favorites`
-- ----------------------------
DROP TABLE IF EXISTS `ht_user_favorites`;
CREATE TABLE `ht_user_favorites` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
BEGIN;
INSERT INTO `ht_users` VALUES ('1', 'admin', '###1ea84146b45085df53864c9c021f584b', 'admin', 'admin@admin.com', '', null, '0', '2000-01-01', null, '127.0.0.1', '2017-03-15 16:46:35', '2017-03-15 04:42:55', '', '1', '0', '1', '0', '');
COMMIT;
