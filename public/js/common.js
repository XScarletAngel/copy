;(function () {
    ...
    $('.page-sidebar-menu ul li a').each(function(index,items){
      var isHref = nowhref.indexOf($(this).attr('href'))
      console.log(isHref)
      if(isHref!=-1){
        ...
        $.each(total_check_all, function () {
            ...
            check_all.change(function (e) {
                ...
                if ($(this).prop('checked')) {
                    ...
                    check_items.attr('checked', true).parent('span').addClass('checked');
                    ...
                    check_items.attr('checked', false).parent('span').removeClass('checked');
...
// 删除功能公共函数
function deleteFun(staus_id,status_url){
