...
return array (
  ...
  'ADMIN_BADWORDS_INDEX' => '黑名单词库',
  'ADMIN_CLASSNOTICE_DEFAULT' => '班务管理',
  'ADMIN_CLASSNOTICE_INDEX' => '班级公告',
  'ADMIN_CLASSUSER_INDEX' => '班级学员管理',
  'ADMIN_COMPLAIN_INDEX' => '投诉管理',
  'ADMIN_EXAMSUBJECTS_INDEX' => '考试科目管理',
  ...
  'ADMIN_MAJOR_DEFAULT' => '数据字典',
  'ADMIN_MAJOR_EDIT' => '编辑',
  'ADMIN_MAJOR_INDEX' => '学科门类管理',
  'ADMIN_MENU_ADD' => '添加菜单',
  ...
  'ADMIN_QUESTION_INDEX' => '问题管理',
  'ADMIN_RBAC_AUTHORIZE_POST' => '提交设置',
  'ADMIN_RBAC_INDEX' => '后台角色管理',
  'ADMIN_RBAC_ROLEADD_POST' => '提交添加',
  'ADMIN_RBAC_ROLEEDIT_POST' => '提交编辑',
  'ADMIN_RECEIVE_INDEX' => '资料领取登记',
  'ADMIN_RESEARCH_INDEX' => '方向管理',
  ...
  'ADMIN_SCHOOL_INDEX' => '院校管理',
  'ADMIN_SCHOOLDEPT_INDEX' => '院系管理',
  'ADMIN_SCHOOLZONE_INDEX' => '校区管理',
  ...
  'ADMIN_STUANSWER_INDEX' => '考试答题查询',
  'ADMIN_STUSCORE_INDEX' => '考试成绩管理',
  'ADMIN_STUSIGN_INDEX' => '考勤管理',
  'ADMIN_SUBJECTS_INDEX' => '科目管理',
  'ADMIN_TOPIC_INDEX' => '话题管理',
  'ADMIN_USER_ADD_POST' => '添加提交',
  'ADMIN_USER_BAN' => '禁用管理员',
  'ADMIN_USER_CANCELBAN' => '启用管理员',
  'ADMIN_USER_EDIT_POST' => '编辑提交',
  'ADMIN_USER_INDEX' => '后台管理员管理',
