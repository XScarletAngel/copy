	...
	<div class="page-container">
		...
		<div class="page-content">
			...
			<div class="container-fluid">
				...
				<!-- 右边主页面开始 -->
				<div class="wrap">
					<form method="post" class="form-horizontal js-ajax-forms" action="<?php echo U('Srv/addPost');?>">
						<fieldset>
							<div class="control-group">
								<label class="control-label">服务名称:</label>
								<div class="controls">
									<input type="text" name="srv_name">
							...
							<div class="control-group">
								...
								<div class="controls">
									<!--<input type="text" name="srv_info">-->
									<textarea name="srv_info" id="" cols="30" rows="5"></textarea>
									<span class="form-required">*</span>
								</div>
							</div>
							...
							<div class="control-group">
								...
								<div class="controls mt8">
									<label class="radio"><input type="radio" name="srv_status" value="1" checked="checked"><em>是</em></label>
									<label class="radio"><input type="radio" name="srv_status" value="0"><em>否</em></label>
								</div>
							</div>
							<div class="control-group">
								<div class="controls">
