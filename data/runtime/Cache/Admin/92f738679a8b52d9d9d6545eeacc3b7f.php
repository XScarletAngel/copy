			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
							<div class="span8 blog-tag-data">
								<div class="top-news indexHtml-a clearfix">
											<a href="#" class="btn green span6">
											<span><?php echo ($con_num); ?></span>
											<em>待处理咨询单</em>
											</a>
											<a href="#" class="btn yellow span6">
											<span><?php echo ($com_num); ?></span>
											<em>待处理投诉单</em>
											</a>
								 </div>
								<h1 class="loginlog">公告信息</h1>
								<?php if(is_array($not)): foreach($not as $key=>$vo): ?><div class="news-item-page news-index">
										<p><?php echo ($vo["content"]); ?></p>
										<span><?php echo ($vo["upd_time"]); ?></span>
									</div><?php endforeach; endif; ?>
							</div>
							<div class="span4">
								<div class="space20"></div>
								<h2 class="loginlog">登陆日志</h2>
								<div class="blog-twitter blog-line">
								<?php if(is_array($log)): foreach($log as $key=>$vo): ?><div class="blog-twitter-block">
										<p><i></i><?php echo ($vo["user_login"]); ?>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ($vo["add_time"]); ?>登陆了系统</p>
									</div><?php endforeach; endif; ?>
								</div>
							</div>
						</div>
