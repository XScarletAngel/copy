...
<div class="row-fluid">
	...
	<div class="span12">
		...
		<?php $str = get_nav_name('/index.php/Admin/Badwords/index'); ?>
		...
		<ul class="breadcrumb">
			...
			<li>
				>
					<?php echo get_bread_nav('/index.php/Admin/Badwords/index');?>
			</li>
		...
		<!-- END PAGE TITLE & BREADCRUMB-->
				...
				<div class="wrap js-check-wrap">
					<form class="well form-search" method="post" action="<?php echo U('Badwords/index');?>">
						关键词：
						<input type="text" name="word" style="width: 200px;" value="<?php echo ($_REQUEST['word']); ?>" placeholder="请输入关键词...">
						<input type="submit" class="btn btn-primary" value="搜索" />
						<input type="reset" class="btn btn-primary" value="清空" />
					</form>
						<a href="<?php echo U('Badwords/add');?>"><input type="button" class="btn btn-primary" value="添加关键词" /></a>
						<table class="table table-hover table-bordered table-list">
							...
							<?php if(is_array($lists)): foreach($lists as $key=>$vo): ?><tr>
								...
								<td>
									<a href="javascript:void();" id-value="<?php echo ($vo["id"]); ?>" class="delete"><?php echo L('DELETE');?></a>
								</td>
							</tr><?php endforeach; endif; ?>
						</table>
						<div class="pagination"><?php echo ($page); ?></div>
				</div>
				<!-- 右边主页面结束 <?php echo U('Badwords/delete',array('id'=>$vo['id']));?>-->
	...
	<script type="text/javascript">
		$(function(){
			$(".delete").click(function(){
			  ...
			  var url = "index.php?g=Admin&m=Badwords&a=delete";
				deleteFun(id,url);
			});
		});
	</script>
