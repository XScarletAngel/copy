...
<div class="row-fluid">
	...
	<div class="span12">
		...
		<?php $str = get_nav_name('/index.php/Admin/Classnotice/index'); ?>
		...
		<ul class="breadcrumb">
			...
			<li>
				>
					<?php echo get_bread_nav('/index.php/Admin/Classnotice/index');?>
			</li>
		...
		<!-- END PAGE TITLE & BREADCRUMB-->
				...
				<div class="wrap js-check-wrap">
					<form class="well form-search" method="post" action="<?php echo U('Classnotice/index');?>">
						<ul class="fromUl clearfix">
							...
							<li>
								...
								<select name="notice_type" style="width: 120px;">
									<option value=''>全部</option>
									<option value='1' <?php if($_REQUEST['notice_type']== 1): ?>selected<?php endif; ?>>学员</option>
									<option value='2' <?php if($_REQUEST['notice_type']== 2): ?>selected<?php endif; ?>>老师</option>
									<option value='3' <?php if($_REQUEST['notice_type']== 3): ?>selected<?php endif; ?>>学员和老师</option>
								</select> &nbsp;&nbsp;
							</li>
							<li>
								公告内容：
								<input type="text" name="notice" style="width: 200px;" value="<?php echo ($_REQUEST['notice']); ?>" placeholder="请输入公告内容...">
							</li>
							<li>
								发布时间：
							...
							<li>
								...
								<select name="status" style="width: 120px;">
									<option value=''>全部</option>
									<option value='1' <?php if($_REQUEST['status']== 1): ?>selected<?php endif; ?>>启用</option>
									<option value='2' <?php if($_REQUEST['status']== 2): ?>selected<?php endif; ?>>停用</option>
								</select> &nbsp;&nbsp;
							</li>
						</ul>
						<div class="frombtn">
						...
						<a href="<?php echo U('Classnotice/add');?>"><input type="button" class="btn btn-primary" value="发布公告" /></a>
						<table class="table table-hover table-bordered table-list">
							...
							<?php if(is_array($notice)): foreach($notice as $key=>$vo): ?><tr>
								...
								<td><?php echo ($vo["zone_sub_name"]); ?></td>
								<td><?php echo ($vo["class_name"]); ?></td>
								<td><?php echo ($vo["notice"]); ?></td>
								<td>
									<?php if($vo["notice_type"] == 1 ): ?>学员
							        	<?php elseif($vo["notice_type"] == 2 ): ?>老师
							        	<?php elseif($vo["notice_type"] == 3 ): ?>学员和老师<?php endif; ?>
							    </td>
							    <td><?php echo ($vo["user_nicename"]); ?></td>
								<td><?php echo ($vo["add_time"]); ?></td>
								<td>
									<?php if($vo["status"] == 1 ): ?>启用
							        	<?php else: ?> 停用<?php endif; ?>
								</td>
								<td id="status">
									<?php if($vo["status"] == 1 ): ?><a href="javascript:void(0);" id-value="<?php echo ($vo["id"]); ?>" status="2" class="status" value="停用">停用</a>
							        	<?php else: ?> <a href="javascript:void(0);" id-value="<?php echo ($vo["id"]); ?>" status="1" class="status" value="启用">启用</a><?php endif; ?>
								</td>
