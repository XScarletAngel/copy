...
<div class="row-fluid">
	...
	<div class="span12">
		...
		<?php $str = get_nav_name('/index.php/Admin/Major/index'); ?>
		...
		<ul class="breadcrumb">
			...
			<li>
				>
					<?php echo get_bread_nav('/index.php/Admin/Major/index');?>
			</li>
				...
				<script>
					...
					$(function(){
						...
						$(".delete").click(function(){
							...
							var url = "index.php?g=Admin&m=Major&a=delete";
