...
class SettingController extends AdminbaseController{
	...
	public function site(){
		...
		$pubmed=$this->options_model->where("option_name='pubmed'")->find();
		...
		// echo "<pre>";print_r($pubmed['option_value']);die;
		$this->assign("pubmed",json_decode($pubmed['option_value'],true));
	...
	public function site_post(){
		if (IS_POST) {
			...
			$pubmed=I('post.pubmed/a');
			$pm_data['option_name']="pubmed";
			$pm_data['option_value']=json_encode($pubmed);
			if($this->options_model->where("option_name='pubmed'")->find()){
				$result=$this->options_model->where("option_name='pubmed'")->save($pm_data);
			}else{
				$result=$this->options_model->add($pm_data);
			}
	...
	public function password_post(){
		if (IS_POST) {
			...
			// $user_obj = D("Common/AdminUsers");
			$user_obj = M("admin_users");
