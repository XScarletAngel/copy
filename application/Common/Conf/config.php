...
//第三方配置文件
if (file_exists("data/conf/third.php")) {
	$third = include 'data/conf/third.php';
} else {
	$third = array();
}
...
$configs= array(
        ...
        /* 配置 */
        'LOAD_EXT_CONFIG'       => 'api', // 扩展配置文件
        'SHOW_PAGE_TRACE'		=> false,
        'TMPL_STRIP_SPACE'		=> true,// 是否去除模板文件里面的html空格与换行
        'THIRD_UDER_ACCESS'		=> false, //第三方用户是否有全部权限，没有则需绑定本地账号
        /* 标签库 */
        'TAGLIB_BUILD_IN' => THINKCMF_CORE_TAGLIBS,
        'MODULE_ALLOW_LIST'  => array('Admin','Portal','Asset','Api','User','Cli','Comment','Qiushi','Tpl','Topic','Install','Bug','Better','Pay','Dict','Msg'),
        ...
        //密钥
        "AUTHCODE" => 'eoT58UobmkuKXpcDeD',
        //cookies
        "COOKIE_PREFIX" => 'o0CZWe_',
...
return  array_merge($configs,$db,$runtime_config,$third);
