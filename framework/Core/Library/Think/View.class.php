...
class View {
    ...
    public function display($templateFile='',$charset='',$contentType='',$content='',$prefix='') {
        ...
        if(isset($_GET) && isset($_GET['xhprof_debug'])) {
            ...
            $XHPROF_ROOT = SPAPP_PATH . "/Lib/Xhprof";
            ...
            $request_uri = str_replace(["/","&"], ["_","_"], $request_uri);
            $time = date("Ymd_H_i_s");
            $ext_name = $time . "_" . $request_uri;

            $run_id = $xhprof_runs->save_run($xhprof_data, $ext_name);
            echo "<a href='/framework/Lib/Xhprof/xhprof_html/index.php?run={$run_id}&source={$ext_name}' target=_blank>性能</a>";
        }
    }
